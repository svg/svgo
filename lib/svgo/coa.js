...
module.exports = function makeProgram(program) {
    program
        ...
        .option('--disable <PLUGINS...>', 'Disable plugin by name, "--disable={PLUGIN1,PLUGIN2}" for multiple plugins (*nix)')
        .option('--enable <PLUGINS...>', 'Enable plugin by name, "--enable={PLUGIN3,PLUGIN4}" for multiple plugins (*nix)')
