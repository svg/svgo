...
/**
 * Flatten an array of plugins each of which could be a comma separated list of plugins.
 *
 * @param {Array} names comma list of plugins names
 * @return {Array} plugins names
 */
function flattenPlugins(names)
{
    var flatNames = [];

    names.forEach(name => flatNames.push.apply(flatNames, name.split(',')));
