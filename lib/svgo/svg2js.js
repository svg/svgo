...
module.exports = function(data, callback) {
    ...
    var saxes = new SAXES.SaxesParser(config.strict, config),
    ...
    saxes.ondoctype = function(doctype) {
        ...
        if (subsetStart >= 0) {
            ...
            while ((entityMatch = entityDeclaration.exec(data)) != null) {
                saxes.ENTITIES[entityMatch[1]] = entityMatch[2] || entityMatch[3];
            }
        }
    };

    saxes.onprocessinginstruction = function(data) {
    ...
    saxes.oncomment = function(comment) {
