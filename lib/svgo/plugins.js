 ...
 * @param {Object} pluginApplyStrategy strategy for applying plugins
 * @return {Object} output data
 */
module.exports = function(data, info, plugins, pluginApplyStrategy) {
    pluginApplyStrategy.applyPlugins(data, plugins, function (group) {
        switch (group[0].type) {
            case 'perItem':
