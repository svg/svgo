 ...
 */
 JSAPI.prototype.hasAttr = function(name, val) {
    ...
    if(name === 'style' && this.style && this.style.length > 0) {
      return true;
    }
 ...
 */
 JSAPI.prototype.hasAttrLocal = function(localName, val) {
    ...
    if(localName === 'style' && this.style && this.style.length > 0) {
        return true;
    }
 ...
 */
 JSAPI.prototype.attr = function(name, val) {
    ...
    if(name === 'style' && this.style && this.style.length > 0) {
      if(this.attrs.style) { // existing style attribute
        this.attrs.style.value = this.style.getCssText();
        return this.attrs.style;
      }
      return { // "virtual" style attribute
        name: 'style',
        value: this.style.getCssText()
      };
    }
 ...
 */
 JSAPI.prototype.addAttr = function(attr) {
    ...
    if(attr.name === 'style' && this.style && this.style.length > 0) {
      this.style.update();
    }
 ...
 */
 JSAPI.prototype.eachAttr = function(callback, context) {
    ...
    if(this.style && this.style.length > 0) {
      callback.call(context, this.attr('style'));
    }
 ...
 */
 JSAPI.prototype.someAttr = function(callback, context) {
    ...
    if(this.style && this.style.length > 0) {
      if (callback.call(context, this.attr('style'))) return true;
    }
