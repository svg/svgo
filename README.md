...
| [clipPaths](https://github.com/svg/svgo/blob/master/plugins/clipPaths.js) | clips the paths in the svg by a given polygon with [martinez](https://github.com/w8r/martinez) |
