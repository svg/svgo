...
Если вы не хотите использовать конфиг по-умолчанию (если, например, вы хотите полностью контролировать весь процесс и не хотите при этом перечислять все возможные плагины в вашей конфигурации), просто добавьте *"dontUseDefaults: true"* в конфиг - ни один плагин не будет загружен без вашего ведома.
