...
Removing a comment like this may be considered a breach of the license terms, as Font Awesome Free is released under [<abbr title="Creative Commons Attribution 4.0 International License">CC-BY-4.0</abbr>](https://creativecommons.org/licenses/by/4.0/), but removing the comment would strip away that attribution.
