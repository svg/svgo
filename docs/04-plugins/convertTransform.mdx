...
svgo:
  ...
  parameters:
    ...
    transformPrecision:
      ...
      default: 5
    matrixToTransform:
      description: If decompose matrices into simple transforms. See [Decomposition of 2D-transform matrices](https://frederic-wang.fr/2013/12/01/decomposition-of-2d-transform-matrices/) for more context.
      default: true
    shortTranslate:
